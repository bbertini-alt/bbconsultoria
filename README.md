...
| ⚙️ **JavaScript**   | Interatividade e comportamento da interface |
| 🔧 **Git**          | Controle de versão                          |
| ☁️ **GitHub Pages** | Publicação do projeto                       |
...
│
├── banner.png          # Imagem principal
├── sobre-1.png         # Imagem da seção Sobre
├── sobre-2.png         # Imagem da seção Sobre
├── projeto-1.png       # Imagem de projeto
├── projeto-2.png       # Imagem de projeto
│
...
* criar uma página para apresentação de trabalhos acadêmicos;
* organizar projetos desenvolvidos durante a graduação;
* praticar desenvolvimento web;
* aplicar conceitos de HTML, CSS e JavaScript;
* desenvolver uma apresentação profissional dos projetos;
* construir uma base para meu portfólio digital.
